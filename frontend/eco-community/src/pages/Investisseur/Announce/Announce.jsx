...
import { Search, Plus, BarChart2, FileText, Settings, LogOut, Menu, X, Calendar, MapPin, Users, DollarSign, HelpCircle, Info, Bell, Tag } from 'lucide-react';
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex space-x-3">
                                        <button className="flex-1 bg-emerald-600 text-white py-2.5 rounded-lg hover:bg-emerald-700 transition-all duration-200 shadow-sm hover:shadow-md">
                                            Postuler
                                        </button>
                    ...
                    {filteredAnnouncements.length === 0 && (
                        <div className="text-center py-12">
                            <div className="bg-white rounded-xl shadow-md p-8 max-w-md mx-auto backdrop-blur-lg bg-opacity-90">
                                ...
                                <p className="text-gray-600 mb-6">Aucune annonce ne correspond à vos critères pour le moment</p>
                                <button
